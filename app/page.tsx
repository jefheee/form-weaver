...
export default function FormWeaver() {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-[#0a0a0a] text-neutral-200 p-6 flex flex-col gap-6 font-sans selection:bg-neutral-800">
      ...
      {/* Header */}
      <header className="flex items-center justify-between border-b border-neutral-800 pb-4 shrink-0 transition-all duration-300">
      ...
      <div className="flex-1 overflow-hidden grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0">
        ...
        <div className="flex flex-col gap-6 min-h-0 h-full">
          ...
          {/* Configuração */}
          <section className="bg-[#121212] border border-[#262626] rounded-xl p-5 shadow-2xl shrink-0 transition-all duration-300">
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-[#0a0a0a] border border-[#262626] rounded-lg pl-3 pr-10 py-2 text-sm focus:outline-none focus:border-neutral-500 transition-all duration-300 ease-in-out placeholder:text-neutral-700"
              ...
              <div className="pt-4 border-t border-[#262626]">
                ...
                <div className="flex gap-4">
                  ...
                  <input 
                    ...
                    min={1}
                    className="w-full flex-1 bg-[#0a0a0a] border border-[#262626] rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-neutral-500 transition-all duration-300 ease-in-out"
                    disabled={isInjecting || isFinished}
                  />
                </div>
              </div>
          ...
          {formTitle && !isFinished && (
            <div className="flex items-center gap-3 shrink-0 animate-in fade-in duration-300">
               <button 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2 bg-[#121212] border border-[#262626] hover:bg-[#1a1a1a] rounded-lg text-xs font-medium text-neutral-300 transition-all duration-300 ease-in-out disabled:opacity-50"
               >
          ...
          {/* Console de Injeção */}
          <section className="bg-[#121212] border border-[#262626] rounded-xl p-5 shadow-2xl flex flex-col flex-1 min-h-0 relative transition-all duration-300">
            {/* Overlay de Sucesso */}
            {isFinished && (
            ...
            <div className="mb-4 shrink-0">
              ...
              <div className="w-full bg-[#0a0a0a] rounded-full h-1.5 border border-[#262626] overflow-hidden">
                <div 
                  className="bg-neutral-100 h-1.5 rounded-full transition-all duration-500 ease-in-out"
            ...
            <div className="grid grid-cols-2 gap-3 mb-4 shrink-0">
              ...
              <button
                ...
                disabled={!isInjecting}
                className="bg-[#0a0a0a] hover:bg-neutral-800 border border-[#262626] text-neutral-300 rounded-lg py-2 text-sm font-medium transition-all duration-300 ease-in-out disabled:opacity-50 flex items-center justify-center gap-2"
              >
            ...
            {/* Terminal Log */}
            <div className="flex-1 bg-[#050505] border border-[#262626] rounded-lg p-3 font-mono text-[10px] leading-relaxed overflow-y-auto custom-scrollbar flex flex-col scroll-smooth">
              {logs.length === 0 ? (
        ...
        <section className="bg-[#121212] border border-[#262626] rounded-xl flex flex-col overflow-hidden h-full transition-all duration-300">
          {questions.length === 0 ? (
            ...
            <div className="flex flex-col h-full animate-in fade-in duration-500">
              {/* Header da Pergunta */}
              <div className="flex items-center justify-between p-5 border-b border-[#262626] bg-[#0a0a0a] shrink-0">
                <div className="flex items-center gap-3">
                  <button 
              ...
              <div className="p-8 flex-1 overflow-y-auto custom-scrollbar flex flex-col relative">
                ...
                <div className="space-y-6 flex-1">
                  {currentQuestion.options.map((opt) => (
                    <div key={opt.value} className="bg-[#0a0a0a] p-4 rounded-xl border border-[#262626] transition-all duration-300 hover:border-neutral-700">
                      <div className="flex items-center justify-between mb-3">
                        <span className="text-sm font-medium text-neutral-300 truncate w-[80%] transition-all duration-300" title={opt.value}>
                          {opt.value}
                        </span>
                        <span className="text-sm font-bold text-neutral-100 bg-neutral-800 px-2 py-1 rounded-md transition-all duration-300 w-12 text-center">
                          {opt.weight}%
                        </span>
                      </div>
                      <input 
                        ...
                        className="w-full accent-neutral-500 h-1.5 bg-neutral-800 rounded-lg appearance-none cursor-pointer transition-all duration-300"
                        disabled={isInjecting || isFinished}
                      />
                    </div>
                  ))}
